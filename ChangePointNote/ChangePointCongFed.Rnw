...
\begin{figure}
    \caption{Congressional Scrutiny of the Federal Reserve Change Point Analysis: Full US House Financial Services Committee \emph{with} Federal Reserve Testimony}
...
\begin{figure}
    \caption{Congressional Scrutiny Change Point Analysis: US House Financial Services Committee \emph{without} Federal Reserve Testimony}
...
e.divGG(data = MainMonth, Vars = EconVars, TimeVar = "MonthYear", 
        sig.lvl = 0.05, R = 999, min.size = 12)
@
...
Minimum state width set at 12 months. \\
