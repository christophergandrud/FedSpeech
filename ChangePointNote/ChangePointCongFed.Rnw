...
\section{Congressional Hearing Transcripts}

We gathered data on congressional hearings--in both the Senate and the House of Representatives--that included the presence of a representative of the Federal Reserve. We aimed to gather (a) all of the transcripts for the hearings where a member Federal Reserve representative gave testimony and (b) all of the transcripts for the hearings of both the US House of Representatives Committee on Financial Services\footnote{From 1995 until 2000 it was known as the Committee on Banking and Financial Services.} and the Senate Committee on Banking, Housing, and Urban Affairs. Both of these committees have the normal responsibility for oversight of the Federal Reserve.
...
# Scrutiny Change Point
ScrutVarsHouse <- c("SumFedHouse", "FedLaughterHouse")
